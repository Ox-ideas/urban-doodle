...
source: "https://agentpedia.codes/blog/karpathy-llm-wiki-idea-file#the-viral-moment"
author:
  - "[[Antigravity.codes]]"
...
The pattern is universal: if you're collecting information from multiple sources over time and want it structured, an LLM Wiki applies. We covered detailed implementations for competitive intelligence, legal compliance, academic literature reviews, and more in our [previous article](https://agentpedia.codes/blog/karpathy-llm-knowledge-bases).
...
- [Part 1: Karpathy's LLM Knowledge Bases — The Post-Code AI Workflow](https://agentpedia.codes/blog/karpathy-llm-knowledge-bases) — Coverage of the original viral tweet
